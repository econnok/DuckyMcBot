module.exports = {
  ...
  // i.e: "-duckymcbot foo" will trigger the command "foo",
  //      whereas "DuckyMcBot foo" will do nothing at all.
  prefix:  "-duckymcbot",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "MjU4NTMyNTE2ODE2NzQ4NTQ3.CzPWPA.1OG79xtkms2kC3OX8AYf-iev5L0",
